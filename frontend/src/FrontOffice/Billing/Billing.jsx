...
const QuickBilling = () => {
  ...
  const handleSubmit = (
    ...
    if (OP_BillingData.PatientId !== 0 && IP_BillingData.PatientId !== '') {
        ...
        <>
          ...
          <div className="RegisterBillType">
            ...
            <div className="csdcedw_kl88">
              <div className="RegisBillSearchForm_1 RegisBillSearchForm_1_mmmm">
                ...
                <div className="Search_patient_icons">
                  <input
                    ...
                    disabled={
                      Object.values(IP_BillingData).length !== 0 ||
                      Object.values(IP_BillingData).length !== 0
                    }
                  />
              ...
              {/* <div className="RegisBillFormcon_mmmmm" ref={gridRef}>
                <div className="RegisterBillType">
                  <label>
                    Search Visit Type <span>:</span>
                  </label>
                  {[
                    "OP",
                    "IP",
                    ...
                    .map((p, ind) => (
                      <div className="RegisBillForm_2" key={ind}>
                        <input
                          type="radio"
                          id={p}
                          name="Visit_type"
