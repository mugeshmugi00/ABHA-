...
const PreOperativeChecklistForm = () => {
  ...
  useEffect(() => {
    if (IpNurseQueSelectedRow?.Booking_Id) {
      axios
        .get(
          `${UrlLink}IP/OT_PreOpChecklist_Details_Link?Booking_Id=${IpNurseQueSelectedRow?.Booking_Id}`)
        .then((response) => {
          const data = response.data[0]
          console.log("Fetched OT Preoperaive data:", data);
  ...
  }, [IpNurseQueSelectedRow?.Booking_Id, getdatastate,UrlLink]);
  ...
  const handleSubmit = () => {
    ...
    const requiredFields = [
      "Date", "Time", "NbmStatus", "NbmStatusRemarks", "PulseBp",
      "PulseBpRemarks", "PreoperativeInj", "PreoperativeInjRemarks", 
      "CheckVeinflowIv", "CheckVeinflowIvRemarks", "InvestigationReport", 
      "InvestigationReportRemarks","PatientConsent","PatientConsentRemarks","JewellryConsentActualStatus",
      "JewellryConsentActualStatusRemarks","DentureRemoval","DentureRemovalRemarks","NailPaint","NailPaintRemarks",
      "SugarLevel","SugarLevelRemarks","PatientAllergy","PatientAllergyRemarks","PatientShave",
      "PatientShaveRemarks","PatientCatheter","PatientCatheterRemarks","BpTablet","BpTabletRemarks",
      "SurgicalSide","SurgicalSideRemarks","XrayCt","XrayCtRemarks","TabMisoprost",
      "TabMisoprostRemarks","Hrct","HrctRemarks","DutySisterName","OtTechName",
    ...
    axios.post(`${UrlLink}IP/OT_PreOpChecklist_Details_Link`, postData)
      .then((res) => {
      ...
      {isPrintButtonVisible ? (
        <div className="Main_container_app">
          <div className="Supplier_Master_Container">
            ...
            {renderSection("15. Check Surgical Site Of Patient Check Preparation Of That Part", "SurgicalSide")}
