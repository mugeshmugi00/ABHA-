...
const CasualityNurseQuelist = () => {
    ...
    useEffect(() => {
        axios.get(`${UrlLink}Frontoffice/get_patient_casuality_details`, { params: searchOPParams })
            .then((res) => {
                const ress = res.data;
    ...
    const handleeditIPPatientRegister = (params) => {
        ...
        const { RegistrationId } = params;
            ...
            axios.get(`${UrlLink}OP/get_workbenchquelist_doctor`, { params: { RegistrationId: RegistrationId, Type: 'Casuality' } })
            .then((res) => {
                console.log(res);

                dispatchvalue({ type: 'Casuality_DoctorWorkbenchNavigation', value:{ ...res.data,...params}});
...
export default CasualityNurseQuelist;